...
<body>
    <main>
        ...
        <div class="card">
            <h3>1-2. feladat</h3>
            <?php
            $fejlec = ['nev', 'elso', 'utolso', 'suly', 'magas'];
            $insert = new SQLGenerator();
            $resultArray = $insert->insert_arrays('balkezes', $fejlec);

            ?>
        </div>
        <div class="card">
            <h3>3. feladat</h3>
            <h4>Határozza meg, hogy hány adatsor található a forrásállományban?</h4>
            <?php
            $lekerdez = new Queries();
            $feladat3 = $lekerdez->feladat3();
            echo 'A feladatban összesen <b>' . $feladat3[0] . '</b> adatsor található';
            ?>
        </div>
        <div class="card">
            <h3>4. feladat</h3>
            <h4>Határozza meg azoknak a játékosoknak a nevét és testmagasságát,<br> akik utoljára 1999 októberében léptek pályára</h4>
            <?php
            $lekerdez = new Queries();
        ...
        <div class="card">
            ...
            <script>
                function sportsuly(str) {
                    ...
                    xmlhttp.open("GET", "Queries.php?evszam=" + str, true);
                    xmlhttp.send();
                }
            </script>
        </div>
